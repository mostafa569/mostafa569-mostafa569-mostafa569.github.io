...
<style>
body{
	background: url("depositphotos_2389847-stock-photo-old-books-in-a-old.jpg");
}
#table1{
		width: 70%;
		text-align: center;
  ...
  .box{
    ...
    background-image: url("jaredd-craig-HH4WBGNyltc-unsplash.jpg");
  ...
  .boxtwo{
    background-image: url("depositphotos_26027471-stock-photo-pile-of-books.jpg");
    background-size: cover;
...
<body>
  <div class="box">
   <table  style =" font-size:16pt"  align="center" width="100%" height="100%" >
      <tr>
        <td style="color:royalblue;text-align:center;"><h1>
...
<table  id="table2">
	...
	<tr>
		...
		<td class="td2">
			...
			<input style="cursor:pointer;" type="submit" name="sub" value="DOWNLOAD"> 
		</td>
	</tr>
	<tr>
