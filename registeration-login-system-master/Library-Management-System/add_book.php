  ...
  border-radius: 12px;
	 ...
	 .header{
			...
			color:#FFFFFF;
			 ...
			 height:370px;
			 margin-left:13%;
       background-image: url("pexels-tamás-mészáros-12064.jpg");
       background-size: cover;
			 box-shadow:0px 0px 15px lightgreen;
       border-radius:12px;
         border:solid 1px #CF0403;
...
<body>
  <div class="box">
   <table  style ="border-color:red; font-size:16pt"  align="center" width="100%" height="100%">
      <tr>
        <td style="color:white"><h1 align="center">Welcome To online Library System</h1></td>
      </tr>
      <tr>
   ...
   <tr>
	...
	<tr>
	 ...
	 <td><input type="file" name="file"  /></td>
      ...
      <tr>
	  <td><h2><input style="margin-left:180%;margin-top:10%;cursor:pointer;" type="submit" name="sub" value="SUBMIT"/></h2></td>
	  </tr>
    <h1>Be careful not to repeat ID !!!!</h2>
   </table>
