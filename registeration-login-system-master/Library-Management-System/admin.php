...
<body>
    ...
    <div class="box">
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
        <tr>
            <td style="color:white"><h1 align="center"><i>Welcome To online Library System</i> </h1></td></tr>
        <tr>
...
<!--    <input type="text" placeholder="search by book id"><button type="button">search</button>  -->
       <p style="text-align:center;color:white;font-weight:bold;background:maroon;" >ALL BOOKS</p>
   <div class="main">
